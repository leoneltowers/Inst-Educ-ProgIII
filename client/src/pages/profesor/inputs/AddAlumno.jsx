...
const AddAlumno= () => {
  ...
  return (
    <Box m="20px">
      <Header title="AGREGAR ALUMNO" subtitle="Agregar nuevo Alumno" />
            ...
            >
              ...
              <Box gridColumn="span 2" sx={{ position: "relative" }}>
                ...
                <Select
                  ...
                  onChange={handleChange}
                >
                  <MenuItem value="option1">Informatica</MenuItem>
                  <MenuItem value="option2">Robotica</MenuItem>
              ...
              <Box gridColumn="span 2" sx={{ position: "relative" }}>
                ...
                <Select
                  ...
                  onChange={handleChange}
                >
                  <MenuItem value="option1">Primero</MenuItem>
                  <MenuItem value="option2">Segundo</MenuItem>
                  <MenuItem value="option3">Tercero</MenuItem>
                </Select>
